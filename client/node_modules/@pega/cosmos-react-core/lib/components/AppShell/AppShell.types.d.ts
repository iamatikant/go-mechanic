import type { KeyboardEvent, MouseEvent, MouseEventHandler, ReactElement, ReactNode, Ref, RefObject } from 'react';
...
interface ContextSwitcherOptions extends BaseProps {
    ...
    onContextClick: (id: MenuItemProps['id'], e: MouseEvent<HTMLButtonElement | HTMLAnchorElement | HTMLInputElement | HTMLDivElement>) => void;
